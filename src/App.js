...
function App() {
    ...
    useEffect(() => {
        ...
        console.log("useEffect!"); // this only happens twice, the interval doesn't retrigger a fetch
    ...
    return (
        ipInfo && (
            <div className="root-wrapper">
                <Map center={ipInfo.location} defaultZoom={13}>
                    <Marker width={50} anchor={ipInfo.location} />
                </Map>
                <div className="IP-card">
                    ...
                    <div className="ip-container">
                        ...
                        <div className="ip-details-wrapper">
                            <h3>
                                <strong>Your IP address is {ipInfo.ip}</strong>
                            </h3>
                            <p>
                                You are currently located in {ipInfo.city},{" "}
                                {ipInfo.country}
                            </p>
                        </div>
                        <hr />
